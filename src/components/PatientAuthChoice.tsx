        ...
        <div className="bg-sky-600 rounded-2xl p-8 shadow-lg border border-sky-300">
          ...
          <div className="space-y-4">
            ...
            <Button
              ...
              variant="outline"
              size="xl"
              className="w-full border-white text-white hover:bg-white hover:text-sky-700"
            >
          ...
          <p className="text-center text-sm text-sky-100 mt-6">
            New patients will receive a unique Patient ID and password after
            registration
          </p>
        </div>
      </div>
